...
// public
    ...
    var retObject = {
        ...
        loadChannels: function () {
            var channelParentElement = ui.removeChannels();
        ...
        loadTableview: function (musics) {
            ...
            for(var i = 0; i < musics.length; ++i) {
                (function() {
                    ...
                    xhr.open('GET', musics[i].picture, true);
                    ...
                    xhr.onload = function (e) {
                        ...
                        $("<li id='song_cover_" + index + "' class='song_cover hide'></li>").css("background-image", "url(data:image/png;base64," + base64 + ")").appendTo($((index % 2 ? "#right" : "#left") + "-cover-list"));
